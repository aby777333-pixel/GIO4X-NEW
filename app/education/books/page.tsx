...
const books: Book[] = [
  {
    ...
    amazonUrl: "https://www.amazon.com/Technical-Analysis-Financial-Markets-Comprehensive/dp/0735200661",
    pages: 576,
    year: 1999,
    rating: 5,
    level: "Intermediate",
...
const enrichedBooks: EnrichedBook[] = books.map((b) => ({
  ...
  amazonUrl: `https://www.amazon.com/s?k=${encodeURIComponent(b.title + " " + b.author)}`,
  pages: 320,
  year: 2010,
  ...b,
}));
                ...
                <div className="flex items-center gap-2">
                  {book.amazonUrl && (
                    <a
                      ...
                      className="inline-flex items-center gap-2 px-4 py-2 rounded-xl bg-[#FF9900] hover:bg-[#E8860D] text-black text-sm font-semibold transition-colors"
                    >
