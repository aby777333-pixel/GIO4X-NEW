  ...
  return (
    <>
      ...
      <PageHero
        ...
        image="gio4x10.png"
        title={<>Find Your <span className="gradient-text">Perfect Account</span></>}
        caption="Three account tiers designed for every level of trader — from beginners exploring the forex markets to professionals demanding raw ECN spreads and Direct Market Access. All accounts support Expert Advisors and Trading Robots, with prime liquidity and advanced charting tools included."
        ctas={[
          { label: "Open Live Account", href: SITE.signUpUrl },
          { label: "Funding & Withdrawals", href: "/funding", variant: "secondary" },
        ]}
      />
