  ...
  return (
    <>
      ...
      <PageHero
        ...
        image="gio4x9.png"
        title={<>Meet <span className="gradient-text">GIO4X Raptor</span></>}
        caption="GIO4X Raptor is our proprietary trading platform engineered for speed, precision, and the demands of professional traders. With leverage up to 500:1, spreads from 0.0 pips, and full EA and Robot compatibility, Raptor is available on iOS, Android, Mac, Windows, and Web."
        ctas={[
