  ...
  return (
    <>
      ...
      <PageHero
        ...
        image="gio4x18.png"
        title={<>Copy Trading — <span className="gradient-text">Make Trading Easy</span></>}
        caption="Mirror the strategies of proven traders automatically. With just 10% profit sharing paid every Monday, a maximum of 200 copiers per provider, and built-in take-profit and stop-loss controls, GIO4X Copy Trading makes professional forex trading accessible to everyone — no experience required."
        ctas={[
          { label: "Start Copying", href: "/accounts" },
